---
title: "Application of poisson mash and mash to simulated single cell data with signal (setting 1)"
author: "Yusha Liu"
header-includes:
date: "2020-7-31"
...
for(iter in 1:20){
  # poisson mash
  post <- readRDS(paste0("output/non_null_sim_v1/pois_mash_posterior_rep_", iter, ".Rds"))
  ...
  # mash
  mash.fit <- readRDS(paste0("output/non_null_sim_v1/mash_fit_rep_", iter, ".Rds"))
