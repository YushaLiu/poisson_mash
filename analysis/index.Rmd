...
Click on this [link](pois_mash_random_effects_sim_non_null_setting1.html) to see results to single cell data simulated with signal by thinning (setting 1). <br/>
Click on this [link](pois_mash_random_effects_sim_non_null_setting2.html) to see results to single cell data simulated with signal by thinning (setting 2).