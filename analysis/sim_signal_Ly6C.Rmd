---
title: "Application of poisson mash and mash to simulated single cell data (Ly6C-) with signal"
author: "Yusha Liu"
header-includes:
date: "2020-9-16"
...
1. add fixed effects to $1,000$ genes randomly chosen from all the genes;
2. add fixed effects to $500$ genes randomly chosen from the genes with relatively high expression (> 80 percentile);
3. add fixed effects to $500$ genes randomly chosen from the genes with medium expression levels (60 ~ 80 percentile);
4. add fixed effects to $500$ genes randomly chosen from the genes with relatively low expression (40 ~ 60 percentile). 
...
load("output/Ly6C-/sim_signal_summary.RData")
...
```{r warning=FALSE, message=FALSE}
load("output/Ly6C-/sim_signal_high_expr_summary.RData")
...
```{r warning=FALSE, message=FALSE}
load("output/Ly6C-/sim_signal_medium_expr_summary.RData")
...
```{r warning=FALSE, message=FALSE}
load("output/Ly6C-/sim_signal_low_expr_summary.RData")
