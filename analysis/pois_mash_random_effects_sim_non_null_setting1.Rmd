...
See [plots](https://github.com/YushaLiu/poisson_mash/blob/master/output/non_null_units_setting1.pdf). \


### Plot ROC for detecting non-null unit-condition pairs
See [plots](https://github.com/YushaLiu/poisson_mash/blob/master/output/non_null_pairs_setting1.pdf). \
