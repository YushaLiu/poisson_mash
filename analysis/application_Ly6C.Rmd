...
Recall the [barplot and enrichment-depletion plot](https://github.com/stephenslab/single-cell-cytokines/blob/master/output/results_by_cell_type/Ly6C-_Monocytes_barplots.pdf) which display single cell-specific loadings grouped by conditions, based on topic modeling of Ly6C- single cell data (the number of topics $K=12$).
